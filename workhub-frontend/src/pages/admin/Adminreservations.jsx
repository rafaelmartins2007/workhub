...
const AdminReservations = () => {
    ...
    const closePanel = () => { setPanelOpen(false); setEditingRes(null); };
            ...
            {panelOpen && editingRes && (
                <div className="admin-form-overlay" onClick={(e) => e.target === e.currentTarget && closePanel()}>
                    <div className="admin-form-panel">
                        ...
                        {/* Informação resumida da reserva */}
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} noValidate>
                            ...
                            <div className="field-group">
                                <label htmlFor="observacoesInternas">
                                    ...
                                    <span className="optional-tag">não visíveis ao cliente</span>
                                </label>
                                <textarea
